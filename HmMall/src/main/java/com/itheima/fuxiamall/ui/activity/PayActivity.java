...
import com.itheima.fuxiamall.bean.SignResult;
...
public class PayActivity extends BaseActivity {
    ...
    @OnClick(R.id.tv_gopay)//支付宝支付
    public void onClick() {
        DialogUtil.showProgressDialog(this,"pay","正在付款");
        //1.从服务器获取订单的签名信息
        getOrderSign("伏峡商城订单","",total+"",order.getOrdernum());
    }
    ...
    public void  OnClickWX(View view){
        Intent intent2 = new Intent(PayActivity.this, WXPayActivity.class);
